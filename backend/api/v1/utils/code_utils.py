...
class CodeManager:
    ...
    _instance = None
    CODE_EXPIRATION_TIME = config.CODE_EXPIRATION_TIME  # seconds
    CODE_EXPIRY_CHECK_INTERVAL = config.CODE_EXPIRY_CHECK_INTERVAL  # seconds
    POSSIBLE_CODES_AVAILABLE = config.POSSIBLE_CODES_AVAILABLE
